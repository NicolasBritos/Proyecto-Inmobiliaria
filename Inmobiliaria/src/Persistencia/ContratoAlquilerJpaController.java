...
public class ContratoAlquilerJpaController implements Serializable {
    ...
    public void create(ContratoAlquiler contratoAlquiler) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findContratoAlquiler(contratoAlquiler.getIdContrato()) != null) {
                throw new PreexistingEntityException("ContratoAlquiler " + contratoAlquiler + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
